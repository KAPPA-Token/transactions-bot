...
const Energy8ABI = require('./abi/KAPPA.abi.json')
...
const KAPPAToken = new web3.eth.Contract(KAPPAABI, KAPPAAddress)
    ...
    .on('data', async (event) => {
        ...
        if (BNBEvent) {
            ...
            broadcaster.sendText(TGChannel, dedent`
                ...
                🎮 <a href='https://kappatoken.net/'>Slime</a> - the first gamers token

                🥞 <a href='https://exchange.pancakeswap.finance/#/swap?outputCurrency=${KAPPAAddress}'>Buy E8</a> | <a href='https://bscscan.com/tx/${transactionHash}'>Tx Hash</a> | <a href='https://poocoin.app/tokens/${KAPPAAddress}'>Poocoin</a> | <a href='https://charts.bogged.finance/?token=${KAPPAAddress}'>Bogget</a>
